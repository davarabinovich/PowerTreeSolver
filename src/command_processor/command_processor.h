...
using PowerTree = ElectricNet; // It's a dependency injection
...
#pragma todo rename to collection
		using Token = string;
		...
		class CommandWorkingWithExsistingTree : public Command
			{
				...
				protected:
					...
					{
						if (isThereSomeActiveTree())	return;
		...
		shared_ptr<ElectricNet_If> activePowerTree;
		...
		bool isThereSomeActiveTree () const;
